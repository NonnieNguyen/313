...
request:	db	"Enter your original message: ", 10
len_r		equ	$-request
...
gstring:
	...
	mov		qword[min_phrase_len], rax	;stores the length of the original string in min_phrase_length

	mov 	rax, 30
	cmp		qword[min_phrase_len], rax ;checks if the string length is atleast 30 char
	jle		gstring	
